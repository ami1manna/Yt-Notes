...
import { UserPlus, Users, Music, FileText, Calendar, Clock } from "lucide-react";
            ...
            <div className="flex items-start space-x-4 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-2 text-base">
                  A collaborative space for sharing physics notes, study materials, and curated playlists to enhance learning.
                </p>
                
                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                  <div className="flex items-center space-x-1">
                    <Users className="w-4 h-4" />
                    <span>Created by <span className="font-medium text-gray-700 dark:text-gray-300">John Doe</span></span>
                  </div>
                  <div className="flex items-center space-x-1">
        ...
        <div className="p-6 sm:p-8 bg-white dark:bg-gray-900">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            <div className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-xl border border-blue-200 dark:border-blue-800 hover:shadow-md transition-all duration-200">
              ...
              <div className="text-sm font-medium text-blue-800 dark:text-blue-300">Active Members</div>
              <div className="text-xs text-blue-600 dark:text-blue-400 mt-1">+2 this week</div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-6 rounded-xl border border-green-200 dark:border-green-800 hover:shadow-md transition-all duration-200">
              ...
              <div className="text-sm font-medium text-green-800 dark:text-green-300">Study Playlists</div>
              <div className="text-xs text-green-600 dark:text-green-400 mt-1">Updated today</div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 p-6 rounded-xl border border-amber-200 dark:border-amber-800 hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">14</div>
              </div>
              <div className="text-sm font-medium text-amber-800 dark:text-amber-300">Shared Notes</div>
              <div className="text-xs text-amber-600 dark:text-amber-400 mt-1">3 new this week</div>
            </div>
          </div>
        </div>
      </Card.Content>
